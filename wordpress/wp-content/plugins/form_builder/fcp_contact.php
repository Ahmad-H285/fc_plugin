...
function fcpContactPage()
{
	...
	if(isset($_GET['id']))
	{
		fcpUpdateForm(CONTACT_FORM_FCP);
	...
	?>
<div>
    <h1 class="col-sm-12">Contact Form</h1>
		...
		<div role="tabpanel" class="tab-pane active" id="forms">
            <form action="" method="POST" class="form-horizontal col-sm-9" id="stored_forms">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php
                        fcpDisplayCreatedForms(CONTACT_FORM_FCP);
                    ?>
                    </tbody>
                </table>
                </div>
			...
			<form action="" method="POST" class="form-horizontal col-sm-9" id="stored_submission">
				<div class="col-sm-12">
					<table class="table table-hover">
						...
						fcpDisplaySubmissions(CONTACT_FORM_FCP);
