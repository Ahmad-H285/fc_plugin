...
if(!class_exists("Ultimate_Headings")){
	class Ultimate_Headings{
		...
		{
			wp_register_style("ultimate-headings-style",plugins_url("../assets/css/headings.css",__FILE__),array(),ULTIMATE_VERSION);
			wp_register_script("ultimate-headings-script",plugins_url("../assets/js/headings.js",__FILE__),array(),ULTIMATE_VERSION);
		}
