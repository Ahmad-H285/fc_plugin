...
if (!empty(EZ::$options['show_google_translate']) || !$inEnglish) {
  ?>
<h4>Admin Pages in your Language</h4>
<p>If you would like to see the amdin pages in your language, you can enable machine tranaslation by Google<sup>&reg;</sup>.</p>
  <?php
$show_google_translate = array('name' => __('Enable Translation?', 'easy-common'),
    'help' => __('This plugin can display its admin pages using Google Translate. If you would like to see the pages in your language, please enable this option. You will then see a language selector near the top right corner where you can choose your language.', 'easy-common'),
    'type' => 'checkbox',
    'reload' => true,
    'value' => false);
?>
<div  class="col-md-12" ><table class="table table-striped table-bordered responsive">
    <thead>
      <tr>
